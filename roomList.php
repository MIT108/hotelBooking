                                                    ...
                                                    <li class="search-product-list-item">
                                                        <a href="javascript:void(0)" class="search-product-list-link">
                                                            ...
                                                            <div class="search-product-list-info">
                                                                ...
                                                                <div class="search-product-list-info-price mt-2">
                                                                    <span
                                                                        class="main-price fw-500 color-light">FCFA 269.00</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </li>
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="hotel-view bg-white radius-20">
                                    <a href="roomDetail.php" class="hotel-view-thumb hotel-view-grid-thumb bg-image"
                                    ...
                                    <div class="hotel-view-contents">
                                        <div class="hotel-view-contents-header">
                                            ...
                                            <h3 class="hotel-view-contents-title"> <a href="roomDetail.php"> King
                                                    Suite Room </a> </h3>
                                        ...
                                        <div class="hotel-view-contents-bottom">
                                            <div class="hotel-view-contents-bottom-flex">
                                                <div class="hotel-view-contents-bottom-contents">
                                                    <h4 class="hotel-view-contents-bottom-title"> FCFA 230 <sub>/Night</sub>
                                                    </h4>
                            ...
                            <div class="col-md-6">
                                <div class="hotel-view bg-white radius-20">
                                    ...
                                    <div class="hotel-view-contents">
                                        <div class="hotel-view-contents-header">
                                            <span class="hotel-view-contents-review"> <i class="las la-star"></i> 4.8
                                                <span class="hotel-view-contents-review-count"> (380) </span> </span>
                                            <h3 class="hotel-view-contents-title"> <a href="roomDetail.php"> Queen
                                                    Size Room </a> </h3>
                                            <div class="hotel-view-contents-location mt-2">
                                                <span class="hotel-view-contents-location-icon"> <i
                                                        class="las la-map-marker-alt"></i> </span>
                                        ...
                                        <div class="hotel-view-contents-bottom">
                                            <div class="hotel-view-contents-bottom-flex">
                                                <div class="hotel-view-contents-bottom-contents">
                                                    <h4 class="hotel-view-contents-bottom-title"> FCFA 170 <sub>/Night</sub>
                                                    </h4>
                            ...
                            <div class="col-md-6">
                                <div class="hotel-view bg-white radius-20">
                                    ...
                                    <div class="hotel-view-contents">
                                        <div class="hotel-view-contents-header">
                                            <span class="hotel-view-contents-review"> <i class="las la-star"></i> 4.7
                                                <span class="hotel-view-contents-review-count"> (380) </span> </span>
                                            <h3 class="hotel-view-contents-title"> <a href="roomDetail.php"> Big
                                                    Size Room </a> </h3>
                                            <div class="hotel-view-contents-location mt-2">
                                                <span class="hotel-view-contents-location-icon"> <i
                                                        class="las la-map-marker-alt"></i> </span>
                                        ...
                                        <div class="hotel-view-contents-bottom">
                                            <div class="hotel-view-contents-bottom-flex">
                                                <div class="hotel-view-contents-bottom-contents">
                                                    <h4 class="hotel-view-contents-bottom-title"> FCFA 200 <sub>/Night</sub>
                                                    </h4>
                                ...
                                <div class="hotel-view bg-white radius-20">
                                    ...
                                    <div class="hotel-view-contents">
                                        <div class="hotel-view-contents-header">
                                            <span class="hotel-view-contents-review"> <i class="las la-star"></i> 4.5
                                                <span class="hotel-view-contents-review-count"> (380) </span> </span>
                                            <h3 class="hotel-view-contents-title"> <a href="roomDetail.php"> Best
                                                    Alishan Room </a> </h3>
                                            <div class="hotel-view-contents-location mt-2">
                                                <span class="hotel-view-contents-location-icon"> <i
                                                        class="las la-map-marker-alt"></i> </span>
                                        ...
                                        <div class="hotel-view-contents-bottom">
                                            <div class="hotel-view-contents-bottom-flex">
                                                <div class="hotel-view-contents-bottom-contents">
                                                    <h4 class="hotel-view-contents-bottom-title"> FCFA 280 <sub>/Night</sub>
                                                    </h4>
                                    ...
                                    <div class="hotel-view-flex">
                                        ...
                                        <div class="hotel-view-contents">
                                            <div class="hotel-view-contents-header">
                                                ...
                                                <h3 class="hotel-view-contents-title"> <a href="roomDetail.php">
                                            ...
                                            <div class="hotel-view-contents-bottom">
                                                <div class="hotel-view-contents-bottom-flex">
                                                    <div
                                                        ...
                                                        <h4 class="hotel-view-contents-bottom-title"> FCFA 230
                                                            <sub>/Night</sub> </h4>
                            ...
                            <div class="col-12">
                                <div class="hotel-view bg-white radius-20">
                                    <div class="hotel-view-flex">
                                        <a href="roomDetail.php"
                                            class="hotel-view-thumb hotel-view-list-thumb bg-image"
                                            style="background-image: url(assets/img/single-page/hotel-list2.jpg);">
                                        </a>
                                        <div class="hotel-view-contents">
                                            <div class="hotel-view-contents-header">
                                                <div
                                            ...
                                            <div class="hotel-view-contents-bottom">
                                                <div class="hotel-view-contents-bottom-flex">
                                                    <div
                                                        class="hotel-view-contents-bottom-contents d-flex flex-wrap gap-4 gap-sm-1">
                                                        <h4 class="hotel-view-contents-bottom-title"> FCFA 170
                                                            <sub>/Night</sub> </h4>
                            ...
                            <div class="col-12">
                                <div class="hotel-view bg-white radius-20">
                                    <div class="hotel-view-flex">
                                        <a href="roomDetail.php"
                                            class="hotel-view-thumb hotel-view-list-thumb bg-image"
                                            style="background-image: url(assets/img/single-page/hotel-list3.jpg);">
                                        </a>
                                        <div class="hotel-view-contents">
                                            <div class="hotel-view-contents-header">
                                                <div
                                            ...
                                            <div class="hotel-view-contents-bottom">
                                                <div class="hotel-view-contents-bottom-flex">
                                                    <div
                                                        class="hotel-view-contents-bottom-contents d-flex flex-wrap gap-4 gap-sm-1">
                                                        <h4 class="hotel-view-contents-bottom-title"> FCFA 200
                                                            <sub>/Night</sub> </h4>
