    ...
    <section class="confirmation-area section-bg-2 pat-100 pab-100">
        <div class="container">
            <div class="confirmation-contents center-text">
                ...
                <p class="confirmation-contents-para"> Dear <?= $Customer['fname']." ".$Customer['lname'] ?>, Your reservation has been confirmed. Please check your mail for reservation invoice. Thanks for
                    reserving our hotel! </p>
                <div class="btn-wrapper flex-btn mt-4 mt-lg-5">
                    <a href="index.php" class="cmn-btn btn-outline-1 color-one"> Back to Home </a>
                    <a href="javascript:void(0)" class="cmn-btn btn-bg-1"> Go to your mail </a>
                </div>
            </div>
        </div>
    </section>
